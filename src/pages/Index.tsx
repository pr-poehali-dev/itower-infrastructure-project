  ...
  const services = [
    {
      ...
      description: "Подбор оптимального места для объекта с учетом безопасности, радиопокрытия и энергоснабжения",
      icon: "Building"
    },
    {
      title: "Металлические конструкции",
      description: "Проектирование и производство под требования самого прихотливого заказчика",
      icon: "Hammer"
    },
    {
      title: "Юридическое сопровождение",
      description: "Полная поддержка при взаимодействии с надзорными органами и жителями",
      icon: "Scale"
    },
    {
      title: "Расчет радиопокрытия",
      description: "Профессиональный расчет радиопокрытия или трассы радиомоста",
      icon: "Radio"
    },
    {
      title: "Оформление земельных участков",
      description: "Полное оформление земельных участков под размещение объектов связи",
      icon: "Map"
    },
    {
      title: "Подключение оптоволокна",
      description: "Подключение оптоволоконного канала связи к вашему объекту",
      icon: "Cable"
    }
  ];
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="max-w-4xl pt-20">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl">
              ...
              для всех операторов мобильной связи в Уральском федеральном округе
            </p>
